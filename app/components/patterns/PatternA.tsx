    ...
    <div className="flex w-full flex-col bg-slate-50 text-slate-800">
      ...
      <div className="w-full border-b border-slate-200 bg-white">
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center justify-between gap-2 px-6 py-4 sm:flex-row">
          <p className="flex items-center gap-2 text-lg font-bold tracking-tight text-slate-900">
      ...
      >
        <div className="mx-auto grid w-full max-w-5xl gap-10 px-6 py-16 md:grid-cols-[1.1fr_1fr] md:items-center md:py-20">
          <div className="flex flex-col items-start gap-5">
            <p className="rounded-full border border-white/25 bg-white/10 px-4 py-1 text-xs font-medium tracking-wide">
              鍵開け・鍵交換・スペアキー作成
            </p>
            ...
            <ul className="mt-2 flex flex-wrap gap-x-5 gap-y-2 text-xs text-white/75">
          ...
          <PlaceholderImage
            label="作業風景の写真"
            className="h-64 w-full rounded-xl bg-white/10 text-white md:h-80"
          />
        </div>
      </section>
      ...
      <section className="w-full bg-slate-50">
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-6 py-16">
          <div className="flex flex-col items-center gap-2 text-center">
            <p className="text-xs font-bold tracking-[0.2em] text-sky-700">
              COMPARISON
            </p>
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-6 py-16">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {PRICING_ITEMS.map((item) => (
              <div
                key={item.name}
                className="flex flex-col gap-3 rounded-xl border border-slate-200 bg-slate-50 p-6 transition hover:border-sky-300 hover:shadow-md"
              >
                <div className="flex items-center gap-2 text-slate-500">
                  <WalletIcon className="h-4 w-4 text-sky-700" />
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-6 py-16">
          ...
          <ol className="grid gap-4 sm:grid-cols-4">
            {FLOW_STEPS.map((step, i) => (
              ...
              >
                <span
                  className="absolute -top-3 left-5 flex h-7 w-7 items-center justify-center rounded-full text-xs font-bold text-white shadow"
      ...
      <section className="w-full border-y border-slate-200 bg-white">
        <div className="mx-auto grid w-full max-w-5xl gap-8 px-6 py-16 md:grid-cols-2 md:items-start">
          <div className="flex flex-col gap-4">
            ...
            <dl className="grid grid-cols-[5.5rem_1fr] gap-y-3 rounded-xl border border-slate-200 bg-slate-50 p-6 text-sm">
          ...
          <PlaceholderImage
            label="店舗外観の写真"
            className="h-56 w-full rounded-xl bg-slate-100 text-slate-500 md:h-full md:min-h-[16rem]"
          />
        </div>
      </section>
